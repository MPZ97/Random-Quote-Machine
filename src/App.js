  ...
  render() {
    return (
      <div>
        ...
        <ul>{this.props.messages.map((list, xdK) => <li key={xdK}>{list}</li>)}</ul>
      </div>
    )
  }
}
...
const App = connect(mapStateToProps, mapDispatcbToProps)(Presentational) */
        ...
        <div id="quote-box" style={boxStyle}>
          ...
          <div style={buttonDiv}>
            <div>
              ...
              {/* text=${this.props.quote}${this.props.author} */}
              <button style={socialButtonStyle}>
                <a id="tumblr-quote" href={`http://twitter.com/intent/tweet?text=${this.props.quote}+${this.props.author} + button_hashtag=quotes`} target="_blank"><FontAwesomeIcon icon={faTumblr} style={{color: 'white', margin: 0}}></FontAwesomeIcon>
                </a>
              </button>
            </div>
